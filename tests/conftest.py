"""pytest configuration for the Helthjem test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.helthjem`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.helthjem import parcels

    parcels._unmapped_statuses_logged.clear()
    parcels._observed_values_logged.clear()
    yield
